...
interface DeliveryOrderWizardSelectItemsStepProps
  extends Partial<StepWizardChildProps> {
  items: SalesOrderLine[]
}

const DeliveryOrderWizardSelectItemsStep = forwardRef<
  AgGridReact,
  DeliveryOrderWizardSelectItemsStepProps
>((props, ref) => {
  const { items } = props
...
export default DeliveryOrderWizardSelectItemsStep
